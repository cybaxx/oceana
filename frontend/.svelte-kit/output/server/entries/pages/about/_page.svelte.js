...
function _page($$renderer) {
  head("cwls5q", $$renderer, ($$renderer2) => {
    $$renderer2.title(($$renderer3) => {
      $$renderer3.push(`<title>about — oceana</title>`);
    });
  });
  $$renderer.push(`<div class="mb-8 text-center"><h1 class="mb-2 text-2xl font-bold text-[var(--ocean-200)]">Oceana</h1> <p class="text-sm text-[var(--terminal-dim)]">An encryption-first social platform built with Rust, SvelteKit, and the Signal Protocol.</p> <div class="mx-auto mt-4 flex flex-wrap justify-center gap-2 text-[10px]"><span class="rounded border border-[var(--terminal-border)] px-2 py-0.5 text-[var(--ocean-400)]">Rust</span> <span class="rounded border border-[var(--terminal-border)] px-2 py-0.5 text-[var(--ocean-400)]">Axum</span> <span class="rounded border border-[var(--terminal-border)] px-2 py-0.5 text-[var(--ocean-400)]">PostgreSQL</span> <span class="rounded border border-[var(--terminal-border)] px-2 py-0.5 text-[var(--ocean-400)]">SvelteKit 5</span> <span class="rounded border border-[var(--terminal-border)] px-2 py-0.5 text-[var(--ocean-400)]">Signal Protocol</span> <span class="rounded border border-[var(--terminal-border)] px-2 py-0.5 text-[var(--ocean-400)]">Ed25519</span> <span class="rounded border border-[var(--terminal-border)] px-2 py-0.5 text-[var(--ocean-400)]">Docker</span></div></div> <nav class="mb-8 rounded border border-[var(--terminal-border)] bg-[var(--ocean-900)]/50 p-4"><p class="mb-2 text-xs font-bold uppercase tracking-wider text-[var(--ocean-300)]">Contents</p> <div class="columns-2 gap-4 text-xs"><a href="#architecture" class="block py-0.5 text-[var(--terminal-dim)] no-underline hover:text-[var(--ocean-300)]">Architecture</a> <a href="#stack" class="block py-0.5 text-[var(--terminal-dim)] no-underline hover:text-[var(--ocean-300)]">Technology Stack</a> <a href="#schema" class="block py-0.5 text-[var(--terminal-dim)] no-underline hover:text-[var(--ocean-300)]">Database Schema</a> <a href="#api" class="block py-0.5 text-[var(--terminal-dim)] no-underline hover:text-[var(--ocean-300)]">API Reference</a> <a href="#auth" class="block py-0.5 text-[var(--terminal-dim)] no-underline hover:text-[var(--ocean-300)]">Authentication</a> <a href="#e2ee" class="block py-0.5 text-[var(--terminal-dim)] no-underline hover:text-[var(--ocean-300)]">E2E Encryption</a> <a href="#feed" class="block py-0.5 text-[var(--terminal-dim)] no-underline hover:text-[var(--ocean-300)]">Feed System</a> <a href="#infra" class="block py-0.5 text-[var(--terminal-dim)] no-underline hover:text-[var(--ocean-300)]">Infrastructure</a> <a href="#roadmap" class="block py-0.5 text-[var(--terminal-dim)] no-underline hover:text-[var(--ocean-300)]">Roadmap</a></div></nav> <div class="space-y-8"><section id="architecture" class="scroll-mt-16"><h2 class="section-heading">Architecture</h2> `);
  Markdown($$renderer, {
    content: `\`\`\`
┌──────────────────────────────────────────────────────────┐
│                       Clients                            │
...
PostgreSQL is the **source of truth** for all transactional data. Neo4j and Redis will be added as supplementary stores for graph queries, caching, and pub/sub.`
  ...
  $$renderer.push(`<!----></section> <section id="stack" class="scroll-mt-16"><h2 class="section-heading">Technology Stack</h2> <h3 class="subsection-heading">Backend</h3> `);
  Markdown($$renderer, {
    content: `| Component | Crate | Purpose |
|---|---|---|
...
| Observability | \`tracing\` | Structured logging |`
  ...
  $$renderer.push(`<!----> <h3 class="subsection-heading mt-4">Frontend</h3> `);
  Markdown($$renderer, {
    content: `| Component | Tool | Purpose |
|---|---|---|
...
| Styling | Tailwind CSS | Utility-first dark ocean theme |`
  ...
  $$renderer.push(`<!----> <h3 class="subsection-heading mt-4">Infrastructure</h3> `);
  Markdown($$renderer, {
    content: `| Component | Tool | Purpose |
|---|---|---|
...
| Cache | Redis 7 *(planned)* | Sessions, feed cache, chat pub/sub |`
  ...
  $$renderer.push(`<!----></section> <section id="schema" class="scroll-mt-16"><h2 class="section-heading">Database Schema</h2> `);
  Markdown($$renderer, {
    content: `\`\`\`sql
CREATE TABLE users (
...
| \`DELETE\` | \`/users/:id/follow\` | Yes | Unfollow a user |`
  ...
  $$renderer.push(`<!----> <h3 class="subsection-heading mt-4">Posts &amp; Feed</h3> `);
  Markdown($$renderer, {
    content: `| Method | Path | Auth | Description |
|---|---|---|---|
...
| \`GET\` | \`/feed\` | Yes | Chronological feed from followed users |`
  ...
  $$renderer.push(`<!----> <h3 class="subsection-heading mt-4">Chat</h3> `);
  Markdown($$renderer, {
    content: `| Method | Path | Auth | Description |
|---|---|---|---|
...
| \`WS\` | \`/ws?token=JWT\` | Yes | Real-time encrypted messaging |`
  ...
  $$renderer.push(`<!----> <h3 class="subsection-heading mt-4">Signal Protocol Keys</h3> `);
  Markdown($$renderer, {
    content: `| Method | Path | Auth | Description |
|---|---|---|---|
...
| \`GET\` | \`/keys/count\` | Yes | Remaining one-time prekey count |`
  ...
  $$renderer.push(`<!----> <h3 class="subsection-heading mt-4">Media</h3> `);
  Markdown($$renderer, {
    content: `| Method | Path | Auth | Description |
|---|---|---|---|
...
| \`GET\` | \`/uploads/:filename\` | | Serve uploaded file |`
  ...
  $$renderer.push(`<!----></section> <section id="auth" class="scroll-mt-16"><h2 class="section-heading">Authentication</h2> `);
  Markdown($$renderer, {
    content: `\`\`\`
Client                                Server
  │                                     │
...
**Expiry handling:** Frontend automatically logs out on 401 and redirects to \`/login\`.`
  ...
  $$renderer.push(`<!----> <h3 class="subsection-heading mt-4">Authorization Model</h3> `);
  Markdown($$renderer, {
    content: `| Action | Rule |
|---|---|
...
| Upload media | Authenticated |`
  ...
  $$renderer.push(`<!----></section> <section id="e2ee" class="scroll-mt-16"><h2 class="section-heading">E2E Encryption</h2> <p class="mb-3 text-xs text-[var(--terminal-dim)]">All chat encryption happens client-side. The server stores only ciphertext and can never read message contents.</p> <h3 class="subsection-heading">Signal Protocol</h3> `);
  Markdown($$renderer, {
    content: `Implemented with \`@privacyresearch/libsignal-protocol-typescript\` providing X3DH key agreement and Double Ratchet message encryption.
...
4. **Double Ratchet** — Derives fresh encryption keys per message for forward secrecy.`
  ...
  $$renderer.push(`<!----> <h3 class="subsection-heading mt-4">Session Establishment (X3DH)</h3> `);
  Markdown($$renderer, {
    content: `\`\`\`
...
**Subsequent:** WhisperMessage (type 1) — Double Ratchet only.`
  ...
  $$renderer.push(`<!----> <h3 class="subsection-heading mt-4">Ed25519 Post Signing</h3> `);
  Markdown($$renderer, {
    content: `Posts are optionally signed with the author's identity key via the Web Crypto API:
...
5. Posts display a **SIGNED** or **BAD SIG** badge accordingly`
  ...
  $$renderer.push(`<!----> <h3 class="subsection-heading mt-4">Key Storage &amp; Trust</h3> `);
  Markdown($$renderer, {
    content: `- **Storage:** IndexedDB, per-user database (\`oceana-keys-{userId}\`)
...
- **Persistence:** Keys survive page reloads and browser restarts`
  ...
  $$renderer.push(`<!----></section> <section id="feed" class="scroll-mt-16"><h2 class="section-heading">Feed System</h2> <h3 class="subsection-heading">Current: Pull-Based Chronological</h3> `);
  Markdown($$renderer, {
    content: `\`\`\`sql
...
Posts from followed users, newest first. Includes signature data for client-side verification and reply counts for threading.`
  ...
  $$renderer.push(`<!----> <h3 class="subsection-heading mt-4">Planned: Graph-Enhanced Ranking</h3> `);
  Markdown($$renderer, {
    content: `\`\`\`cypher
...
Neo4j will score posts by engagement and author affinity, blending reaction count with interaction history.`
  ...
  $$renderer.push(`<!----></section> <section id="infra" class="scroll-mt-16"><h2 class="section-heading">Infrastructure</h2> `);
  Markdown($$renderer, {
    content: `One command runs the entire stack:
...
The Vite dev server proxies all API and WebSocket requests to the backend container, so the frontend can be accessed at \`http://localhost:5173\` with no CORS issues.`
  ...
  $$renderer.push(`<!----></section> <section class="scroll-mt-16"><h2 class="section-heading">Content Rendering</h2> `);
  Markdown($$renderer, {
    content: `Posts support GitHub Flavored Markdown with syntax-highlighted code blocks.
